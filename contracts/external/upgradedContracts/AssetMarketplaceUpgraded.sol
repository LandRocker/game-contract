...
contract AssetMarketplaceUpgraded is Initializable, UUPSUpgradeable,ReentrancyGuardUpgradeable,IAssetMarketplaceUpgraded {
        ...
        validQuantity(_sellUnit)
    {
        ...
        require(assetSell.sellUnit > 0, "AssetMarketplace::The sell does not exist");
    ...
    function buyItem(uint256 _sellId) external override nonReentrant {
        ...
        if (payWithBalance) {
            ...
            (,uint256 vestedAmount,uint256 claimedAmount) = lrtVesting.holdersStat(
                msg.sender
            );
            require(
